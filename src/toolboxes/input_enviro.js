export const inputBlocksEnviro = {
    ...
    contents: [
      ...
      { kind: 'block', type: 'get_humidity' },
      { kind: 'block', type: 'get_uv' },
      //{ kind: 'block', type: 'get_co' },
      //{ kind: 'block', type: 'get_co2' },
      //{ kind: 'block', type: 'get_so2' },
      //{ kind: 'block', type: 'get_no2' },
      //{ kind: 'block', type: 'get_o3' },
      //{ kind: 'block', type: 'get_pm25' }
    ]
  };
