export const inputBlocksPhysio = {
  ...
  contents: [
    ...
    { kind: 'block', type: 'get_low_voltage' },

    // ↓↓↓ ДОБАВЛЕНО по спецификации Physio ↓↓↓
    { kind: 'block', type: 'physio_get_barometer' },   // barometer (mBar), code 4
    { kind: 'block', type: 'physio_get_microphone' },  // microphone (V), code 33
    { kind: 'block', type: 'physio_get_accel_x' },     // acceleration X, code 35 ch0
